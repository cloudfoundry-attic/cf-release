...
public class BillingPresenter extends BaseDashboardGraphPresenter<BillingPresenter.MyProxy> {
  ...
  public BillingPresenter(EventBus eventBus, MyView view, MyProxy proxy, PlaceManager placeManager,
    ...
    addGraph(graphs.getGraph("billing.errors.400"));
    addGraph(graphs.getGraph("billing.errors.401"));
    addGraph(graphs.getGraph("billing.errors.402"));
    addGraph(graphs.getGraph("billing.errors.403"));
    addGraph(graphs.getGraph("billing.errors.404"));
    addGraph(graphs.getGraph("billing.errors.500"));
    addGraph(graphs.getGraph("billing.errors.501"));
    addGraph(graphs.getGraph("billing.errors.502"));
  }
