...
require "collector/billing_handler"
...
module Collector
  ...
  AUDIT_SERVICE_COMPONENT = "AuditService"
  ...
  class Collector
    ...
    def initialize
      ...
      @core_components = Set.new([CLOUD_CONTROLLER_COMPONENT, DEA_COMPONENT,
                                  ...
                                  ACCOUNT_MANAGER_COMPONENT, AUDIT_SERVICE_COMPONENT,
                                  BILLING_SERVICE_COMPONENT, EVENT_AGGREGATOR_COMPONENT,
                                  NOTIFICATION_SERVICE_COMPONENT, REPORT_PROCESSOR_COMPONENT,
                                  QUOTA_ENFORCER_COMPONENT])
